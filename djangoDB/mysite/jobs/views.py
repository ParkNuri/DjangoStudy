...
#    url = f'https://search.naver.com/search.naver?where=image&query={person.past_job}'
...
#    pprint(data)
 ...
 #           'person' : person,
 #       }
    return render(request, 'jobs/your_champ.html', context)
